...
function VestaLearnings() {
  return (
    <div className="vesta-learnings">
      ...
      <p><a href="https://vestafinance.xyz/">Vesta Finance</a> was a project that I co-founded in 2022. I learned a lot from this project, and I want to share some of the key learnings here.</p>
      <section>
        ...
        <ul>
          ...
          <li>Pioneered the first <a href="https://curia.vestafinance.xyz/t/rfc-new-interest-rate-framework/274">real-time market-trailing interest rate mechanism</a> for a stablecoin, navigated complex stakeholder landscape of engineering, legal, investors and users to implement the design, achieving 8x revenue growth while preserving 95% of deposits.</li>
      ...
      <section>
        ...
        <p>TL;DR</p>
        <p>Vesta failed to achieve significant product-market fit due to artificial initial traction from token emissions, misaligned user expectations, and internal misalignment. Internal challenges was ultimately the cause of the project's demise, including lack of solid product development processes and cultural misalignment. Despite these issues, Vesta returned $14M in capital back to investors, more than $2M than raised. To read more about what I learned, please refer to my in-depth analysis of Vesta's dissolution below.</p>
        <h3><a href="https://zespace.notion.site/Why-Vesta-Dissolved-an-Analysis-e54af7f942984a0ca0dc3f44bf5fdba6">More to the story</a></h3>
      </section>
    </div>
  );
}
